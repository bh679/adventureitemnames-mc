 ...
 * {@code context/player_name} ref resolves.
 *
 ...
 */
public record NamingContext(Optional<String> playerName) {

    /** Sentinel for naming paths with no extra context. */
    public static final NamingContext EMPTY = new NamingContext(Optional.empty());
    ...
    public static NamingContext ofPlayer(String name) {
        ...
        return new NamingContext(Optional.of(name));
    }
}
